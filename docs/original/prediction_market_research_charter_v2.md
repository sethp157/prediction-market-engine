...
**Revision 2.1 — 2026-09-17.** Filename retained for continuity. This revision clarifies decision authority, permitted exploratory work, historical AI contamination, and entry into live validation. It does not close any research gate.

**Starter package:** Read `AGENTS.md`, this charter, `PROJECT_CONTEXT.md`, and `RESEARCH_STATE.md`. Begin with Q1 only. The larger repository scaffold below is a future reference, not an instruction to create every component now.
...
Primary probabilistic scoring rules should include:
...
**Gate 1:** We do not proceed until the claim is precise and falsifiable.
...
10. Results must be reproducible from repository state.
